...
export class MovieComponent implements OnInit {
  ...
  secondRowData:any=[]
  thirdRowData:any = []
  searchBoxClass:any = 'hide-search'

  row1Status = false;
  row2Status = false;
  row3Status = false;
  searchIconStatus : boolean = false;
  constructor() { }
  ...
  {
    this.id=id
    this.row1Status= true
    this.row2Status = false;
    this.row3Status = false;
  ...
  {
    this.id=id
    this.row1Status= false
    this.row2Status = true;
    this.row3Status = false;
  ...
  "Plot": "James \"Ghost\" St. Patrick, a wealthy New York night club owner who has it all, catering for the city's elite and dreaming big, lives a double life asa drug kingpin.",
  "Language": "English",
  "Country": "USA",
  ...
  "Plot": "When Callum Lynch explores the memories of his ancestor Aguilar andgains the skills of a Master Assassin, he discovers he is a descendant of the secret Assassins society.",
  "Language": "English",
...
thirdRow() {
  for(let i=10;i<15;i++) {
    this.thirdRowData.push(this.data[i])
  }
}
  showSearchBox() {
      this.searchBoxClass = "search-box";
      this.searchIconStatus = true;
  }

  closeSearchBox() {
    this.searchBoxClass = "hide-search";
    this.searchIconStatus = false;
  }
}
